...
public class ReviewController {
    ...
    @GetMapping("{id}")
    public Review getById(@Valid @PathVariable("id") Long reviewId) {
    ...
    public void addLike(@Valid @PathVariable("id") Long id, @Valid @PathVariable("userId") Long userId) {
        reviewService.addLike(id, userId);
        log.info("Добавление лайка для отзыва {}, user id {}", id, userId);
    }

    @PutMapping("/{id}/dislike/{userId}")
    public void addDislike(@Valid @PathVariable("id") Long id, @Valid @PathVariable("userId") Long userId) {
    ...
    public void deleteLike(@Valid @PathVariable("id") Long id, @Valid @PathVariable("userId") Long userId) {
        log.info("Удаление лайка для отзыва {}", id);
        reviewService.deleteLike(id, userId);
    }

    @DeleteMapping("/{id}/dislike/{userId}")
    public void deleteDislike(@Valid @PathVariable("id") Long id, @Valid @PathVariable("userId") Long userId) {
